      ...
      <main className="relative ">
        ...
        <section className="flex h-screen w-full overflow-hidden bg-[url('../pic/team_bg.svg')] bg-cover px-[5vw]">
          <div className="flex h-screen w-full justify-center gap-2">
            {/* 左半裝飾字-Teams */}
            <h2 className="h-screen font-['Ubuntu'] font-bold leading-none text-white [text-orientation:sideways] [text-shadow:5px_-5px_#74D3E5] [writing-mode:vertical-lr] lg:w-[15vw] lg:text-[11rem] text-9xl xl:w-[15vw] xl:text-bg">
              Teams
            </h2>
            {/* 右半內容區 */}
        ...
        <section className="flex h-screen w-full  bg-gradient-to-b from-[#026D8A] via-[#01405E] to-[#030b17] px-[5vw]">
          <div className="flex w-full flex-row-reverse items-center justify-center">
            <h2 className="h-screen w-[12vw] overflow-hidden font-['Ubuntu'] xl:text-bg lg:text-[11rem] text-9xl font-bold leading-none text-white [text-orientation:sideways] [text-shadow:5px_-5px_#74D3E5] [writing-mode:vertical-lr]">
              News
            </h2>
            <div className="flex w-[70vw] flex-col  items-center justify-center gap-y-4 px-10">
              <h3 className="w-full xl:text-2xl lg:text-xl text-lg font-bold text-[#FFCC66]">
                熱門新聞
              </h3>
              <NewsLink />
              <h3 className="mt-4 w-full xl:text-2xl lg:text-xl text-lg font-bold text-[#FFCC66]">
                盃賽資訊
              </h3>
              <div className="no-scrollbar flex w-full justify-start xl:gap-10 lg:gap-6 gap-4 overflow-x-auto">
                <CupGame cardWidth={"xl:w-[340px] lg:w-[320px] w-[260px] shrink-0 "} />
                <CupGame cardWidth={"xl:w-[340px] lg:w-[320px] w-[260px] shrink-0 "} />
                <CupGame cardWidth={"xl:w-[340px] lg:w-[320px] w-[260px] shrink-0 "} />
                <CupGame cardWidth={"xl:w-[340px] lg:w-[320px] w-[260px] shrink-0 "} />
                <CupGame cardWidth={"xl:w-[340px] lg:w-[320px] w-[260px] shrink-0 "} />
