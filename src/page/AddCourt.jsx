...
const AddCourt = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-14 bg-gradient-to-b from-[#082A4D] to-[#000000] pt-28">
      {/* 新增球場 */}
      ...
      {/* 球場列表 */}
      <h2 className="text-3xl w-full text-center text-white">球場列表</h2>
