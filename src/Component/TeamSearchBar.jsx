      ...
      <div className="flex w-full items-center justify-start gap-5">
        ...
        <div className="scroll-style no-scrollbar flex w-full gap-2 overflow-x-auto">
          <label htmlFor="台北教育大學" className="">
            ...
            <div className="cursor-pointer justify-center whitespace-nowrap rounded-full border border-transparent bg-black/30 px-5 py-2 font-medium leading-6 tracking-wider text-white/60 duration-500 hover:border-white/50 hover:text-white/80 peer-checked:border-white/80 peer-checked:bg-[#123659] peer-checked:text-white">
              台北教育大學
            </div>
          </label>
