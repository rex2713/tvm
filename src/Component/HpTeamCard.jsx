...
const HpTeamCard = () => {
  ...
  return (
    <div className="no-scrollbar flex w-full items-start justify-start gap-[2vw] overflow-x-auto ">
      {teamData &&
        teamData.length !== 0 &&
        ...
        teamData.map((team) => {
          ...
          return (
            <div
              key={uuidv4()}
              className="flex h-[340px] md:h-[440px] xl:h-[480px] w-[220px] md:w-[340px] xl:w-[380px] shrink-0 flex-col items-center justify-between gap-1 sm:gap-4 rounded-3xl border border-transparent bg-[#123659] p-2 sm:p-4 shadow-sm duration-500 hover:border-white/30"
            >
              {/* 隊伍基本資訊 */}
