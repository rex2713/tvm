...
const MemberNav = ({ isLogIn, setIsLogIn }) => {
  ...
  return (
    <section className="flex h-[240px] w-full flex-col items-center justify-end bg-gradient-to-b from-[#082A4D] via-[#041526] to-[#000000] px-[5vw] pb-5 gap-3 md:flex-row md:items-end md:justify-between">
      <h2 className="font-['Ubuntu'] text-[72px] font-bold text-white [text-shadow:4px_4px_#A8D916] sm:text-[72px] sm:leading-none lg:text-[110px] xl:text-[140px]">
        Member
      </h2>
