...
const TeamCard = () => {
  ...
  return (
    ...
    <div className="no-scrollbar grid w-full grid-cols-3 items-start justify-start gap-10 overflow-x-auto">
      {teamData &&
        teamData.length !== 0 &&
        teamData.map((team) => {
                ...
                {team.teamMember &&
                  team.teamMember.map((member) => {
                    return (
                      <div
                        key={uuidv4()}
                        className="flex w-full flex-col items-center justify-center gap-1 rounded-2xl bg-black/20 p-2"
                      >
                        <div className="flex w-full flex-col items-center justify-center gap-1">
                          <img
                            loading="lazy"
